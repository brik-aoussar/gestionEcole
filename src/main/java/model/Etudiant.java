...
public class Etudiant {
    ...
    public Etudiant() {}
    public Etudiant(String cne, String nom, String prenom, LocalDate dateNaissance, String email) {
        this.cne = cne; this.nom = nom; this.prenom = prenom;
        this.dateNaissance = dateNaissance; this.email = email; this.statut = Statut.ACTIF;
    }
    ...
    public LocalDate getDateNaissance() { return dateNaissance; } public void setDateNaissance(LocalDate d) { this.dateNaissance = d; }
    ...
    public Statut getStatut() { return statut; } public void setStatut(Statut statut) { this.statut = statut; }
    ...
    @Override public boolean equals(Object o) { if (this == o) return true; if (!(o instanceof Etudiant e)) return false; return Objects.equals(id, e.id) || Objects.equals(cne, e.cne); }
    @Override public int hashCode() { return Objects.hash(id, cne); }
    @Override public String toString() { return "Etudiant{id=" + id + ", cne='" + cne + "', nom='" + nom + " " + prenom + "'}"; }
}
